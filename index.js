...
=> NOTES
• MAU AMBIL CASE? ADD NAMA AlyaaXzy DI THX TO
• JGN DIPERJUAL BELIKAN
• THX TO JGN DI GANTI
• NAMA OTHER AlyaaXzy JGN DIHAPUS
*/
const {
    WAConnection,
    MessageType,
...
audio20 = fs.readFileSync('./X3/nayla20.m4a') 
            ...
            nayla.sendMessage(mdata.id,  nnnyz6, MessageType.buttonsMessage,{caption: 'whatsapp',"contextInfo": {text: 'BOTZ18', "forwardingScore": 1000000000, isForwarded: true, sendEphemeral: true, "mentionedJid" : [memJid], },sendEphemeral: true})                         
			}
...
menu4 = "BOTZ VERSI 18 NEWS : https://myselfff.herokuapp.com/file"  
            try{ 
